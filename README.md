...
* **⚖️ LoRA vs. DoRA**: For small-scale cultural datasets, **LoRA outperformed DoRA**. While accuracy was comparable, DoRA's weight-decomposition proved too sensitive to sparse data, increasing training time without significant gains.[Lora_vs_Dora](results/E3.png)
